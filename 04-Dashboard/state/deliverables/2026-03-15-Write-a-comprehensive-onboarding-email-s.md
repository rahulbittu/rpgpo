...
## Research SaaS onboarding email best practices
...
- **Measure**: Track open/CTR drop (target <5% per email), completion rates; iterate on top performers like Semrush/Trello.[1][2]

Sources:  
- [1] https://userpilot.com/blog/onboarding-email-best-practices/  
- [2] https://churnward.com/blog/saas-onboarding-best-practices/  
- [3] https://www.sequenzy.com/for/automate-onboarding  
- [4] https://www.eleken.co/blog-posts/user-onboarding-best-practices  
- [6] https://www.howdygo.com/blog/saas-reactivation-email-examples

## Synthesize onboarding email sequence
## 5-Email Onboarding Sequence for New SaaS Customers

### Email 1: Welcome & Quick Start
**Subject Line**: "Welcome to [SaaS Name]! Let's Get You Started in 3 Easy Steps"

**Body Copy**:
```
Hi [Name],

Welcome aboard! We're thrilled to have you join the [SaaS Name] community. Let's get you up and running with your first task in just 3 easy steps.

1. [Step 1: Brief description]
2. [Step 2: Brief description]
3. [Step 3: Brief description]

Ready to dive in? Click below to start your journey.
...
### Email 2: Feature Highlight & Social Proof
**Subject Line**: "Discover [Feature] and See How Others Are Succeeding!"

**Body Copy**:
```
Hey [Name],

Did you know that [Feature] can help you [benefit]? Many of our users have seen incredible results, like [Customer Success Story or Statistic].

Take a look at how [Feature] can work for you.
...
### Email 3: Progress Check & Support Offer
**Subject Line**: "Need a Hand? We're Here to Help!"

**Body Copy**:
```
Hi [Name],

We noticed you haven't completed setting up your account. No worries, we're here to help!

If you have any questions or need assistance, just reply to this email. Our support team is ready to guide you through any step.
...
### Email 4: Advanced Tips & Community Engagement
**Subject Line**: "Unlock Advanced Tips & Join Our Community"

**Body Copy**:
```
Hey [Name],

Ready to take your skills to the next level? Check out these advanced tips and tricks to maximize your use of [SaaS Name].

Plus, join our community of users to share insights and get inspired!
...
### Email 5: Feedback Request & Continued Support
**Subject Line**: "How's Your Experience So Far? We'd Love Your Feedback!"

**Body Copy**:
```
Hi [Name],

It's been a couple of weeks since you started with [SaaS Name], and we hope you're enjoying it. We'd love to hear your thoughts!

Your feedback helps us improve and serve you better. Plus, if you have any questions or need further assistance, we're just an email away.
...
## Recommended Actions
1. **Implement Email Automation**: Use tools like Mailchimp or HubSpot to automate this sequence, ensuring timely delivery based on user behavior.
   - **Why**: Automation increases efficiency and ensures emails are sent at optimal times.
   - **Expected Outcome**: Improved user engagement and satisfaction.
   - **First Step**: Set up your email automation tool and input the email sequence.
