...
exports.getCompletionReport = getCompletionReport;
function uid() { return 'wc_' + Date.now().toString(36) + Math.random().toString(36).slice(2, 6); }
...
//# sourceMappingURL=operator-workflow-completion.js.map