...
exports.name = exports.key = void 0;
exports.getTemplates = getTemplates;
exports.buildPrompt = buildPrompt;
exports.merge = merge;
exports.computeDeliverableId = computeDeliverableId;
const crypto = require('crypto');
exports.key = 'topranker';
exports.name = 'TopRanker Engine';
...
function buildPrompt(templateId, input) {
...
function computeDeliverableId(templateId, input) {
...
module.exports = { key: exports.key, name: exports.name, getTemplates, buildPrompt, merge, computeDeliverableId };
//# sourceMappingURL=topranker-engine.js.map