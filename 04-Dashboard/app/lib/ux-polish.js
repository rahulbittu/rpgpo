...
exports.getDrilldowns = getDrilldowns;
exports.getJourneys = getJourneys;
exports.getConsistencyReport = getConsistencyReport;
function uid() { return 'ux_' + Date.now().toString(36) + Math.random().toString(36).slice(2, 6); }
...
function getConsistencyReport() {
    ...
    try {
        ...
        navGaps = nc.getGaps().length;
    }
    catch { /* */ }
    let navEntries = 0;
    try {
        const nc = require('./navigation-consistency');
        navEntries = nc.getMap().length;
    }
    catch { /* */ }
    ...
    try {
        ...
        refreshPlans = tr.getPlans().length;
    }
    catch { /* */ }
...
//# sourceMappingURL=ux-polish.js.map