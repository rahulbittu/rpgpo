...
exports.getProviderCapability = getProviderCapability;
exports.decideProviderRouting = decideProviderRouting;
const CAPABILITIES = [
    {
 ...
 */
function decideProviderRouting(preferredProviderId, config, context = 'subtask') {
    ...
    if (routing === 'force-config') {
        ...
        const mode = config.providerModes[providerId] || 'prompt-sentinel';
        return {
            providerId, mode,
            structuredPath: true,
