...
exports.getExpandedBindings = getExpandedBindings;
exports.getExpansionReport = getExpansionReport;
exports.getByCategory = getByCategory;
function uid() { return 'rpe_' + Date.now().toString(36) + Math.random().toString(36).slice(2, 6); }
/** All protected route bindings — ship-critical + expanded */
function getExpandedBindings() {
    return [
...
function getExpansionReport() {
    ...
    const delta = { before: 8, after: fullyGuarded, new_guards: fullyGuarded - 8, detail: `Part 55: 8 guards → Part 56: ${fullyGuarded} guards (+${fullyGuarded - 8} new)` };
...
//# sourceMappingURL=route-protection-expansion.js.map