...
function getQuickActions() {
    return [
        ...
        { id: 'qa_job_search', label: 'Job Search $180k+', description: 'Find high-paying data eng jobs', category: 'research', endpoint: '/api/intake/run', method: 'POST', body: { raw_request: 'Search the web for current data engineering job openings paying $180,000+ per year. Focus on remote-friendly roles at top companies. For each listing include: company name, exact role title, salary range, location/remote, key requirements, and where to apply. Prioritize roles posted in the last 30 days.', domain: 'careeregine', urgency: 'high' } },
        { id: 'qa_salary_bench', label: 'Salary Benchmark', description: 'What should I be earning?', category: 'research', endpoint: '/api/intake/run', method: 'POST', body: { raw_request: 'Research current salary benchmarks for senior/staff/principal data engineers in 2026. Include base salary by level and location, total compensation, and negotiation tactics. Use real data from levels.fyi and similar sources.', domain: 'careeregine', urgency: 'normal' } },
