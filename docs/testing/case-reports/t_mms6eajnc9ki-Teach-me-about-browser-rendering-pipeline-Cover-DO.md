...
- **Task ID**: `t_mms6eajnc9ki`
- **Engine**: general
### Request
> Teach me about browser rendering pipeline. Cover DOM construction, CSSOM, layout, paint, and compositing. Include performance optimization tips.

## Phase 2: Board Deliberation
**Objective**: Teach the user about the browser rendering pipeline with performance optimization tips.
**Strategy**: Research and compile a detailed explanation of each stage of the browser rendering pipeline. Provide practical performance optimization tips tailored to common bottlenecks in the process. Ensure the content is accessible to someone with a technical background.

## Phase 3: Execution

### Step 1: Research Browser Rendering Pipeline [perplexity]
...
### Step 2: Compile Performance Optimization Tips [perplexity]
...
### Step 3: Synthesize Browser Rendering Pipeline Explanation [openai]
## Key Findings
...
## Phase 4: Deliverable
- /api/intake/task/t_mms6eajnc9ki/export?fmt=md
