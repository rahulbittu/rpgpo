...
- **Objective**: Explain event-driven architecture patterns with practical examples, trade-offs, and common mistakes.
...
### Subtask 1: Research Event-Driven Architecture Patterns
