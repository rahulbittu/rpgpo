...
- **Task ID**: `t_mms6o8zkyvmp`
- **Engine**: general
### Request
> Write a comprehensive guide to database indexing anti-patterns. Include over-indexing, wrong column order, and unused indexes. With PostgreSQL query plan examples.

## Phase 2: Board Deliberation
**Objective**: Create a detailed guide on database indexing anti-patterns with PostgreSQL examples.
**Strategy**: Conduct research on database indexing anti-patterns, focusing on over-indexing, wrong column order, and unused indexes. Use PostgreSQL query plan examples to illustrate these concepts. Compile the findings into a clear and concise guide tailored for database professionals.

## Phase 3: Execution

### Step 1: Research Database Indexing Anti-Patterns [perplexity]
...
**Search Limitations**: No results from last 3

### Step 2: Synthesize Guide on Indexing Anti-Patterns [openai]
## Key Findings
...
3. **Regular Index Maintenance**:
   - **What to do**: Schedule regular maintenanc

## Phase 4: Deliverable
- /api/intake/task/t_mms6o8zkyvmp/export?fmt=md
