...
- **Task ID**: `t_mms6619rzqlg`
- **Engine**: general
### Request
> Write a security audit checklist for a Node.js REST API. Include authentication, authorization, input validation, rate limiting, CORS, and dependency scanning.

## Phase 2: Board Deliberation
**Objective**: Create a comprehensive security audit checklist for a Node.js REST API.
**Strategy**: Develop a checklist by researching best practices and current standards in Node.js REST API security. Ensure the checklist is comprehensive and practical, addressing all specified areas. Tailor the content to be immediately usable by developers or security auditors.

## Phase 3: Execution

### Step 1: Research Node.js REST API Security Best Practices [perplexity]
...
### Step 2: Compile Security Audit Checklist [openai]
## Key Findings
...
1. **Implement Helmet Middleware**
   ...
   - **First Step**: Run `npm i helmet` and add `app

## Phase 4: Deliverable
- /api/intake/task/t_mms6619rzqlg/export?fmt=md
