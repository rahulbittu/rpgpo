...
- **Urgency**: normal
- **Download**: [Markdown](/api/intake/task/t_mms3m66gedpw/export?fmt=md) | [JSON](/api/intake/task/t_mms3m66gedpw/export?fmt=json)
...
- **Objective**: Explain CAP theorem, PACELC, and consistency models using database examples, and recommend a database choice.
...
- **Risk**: green
- **Subtasks planned**: 2
- **Key unknowns**: Current real-world applications of CAP theorem and PACELC; Specific use cases for Cassandra, CockroachDB, and Spanner

## 3. Subtask Execution

### Subtask 1: Research CAP theorem, PACELC, and consistency models
...
### Subtask 2: Synthesize research into a report
