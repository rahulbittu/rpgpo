...
- **Task ID**: `t_mms6nweuwys5`
- **Engine**: general
### Request
> Teach me about Linux performance tuning for database servers. Cover kernel parameters, I/O schedulers, memory management, and monitoring tools.

## Phase 2: Board Deliberation
**Objective**: Create a comprehensive learning module on Linux performance tuning for database servers.
**Strategy**: Research the key areas of Linux performance tuning relevant to database servers. Compile a detailed report that explains kernel parameters, I/O schedulers, memory management, and monitoring tools, using clear analogies and structured progression from simple to complex. Ensure the content is adaptable to different learning levels.

## Phase 3: Execution

### Step 1: Research Linux Kernel Parameters [perplexity]
...
### Step 2: Research I/O Schedulers [perplexity]
...
```
ACTION=="add|change", KERN

### Step 3: Research Memory Management Techniques [perplexity]
...
- Next steps: 1) Benchmark current setup with pgbench (scale=1000, 1

### Step 4: Research Monitoring Tools [perplexity]
...
dbForge Edge's Session Manager monitors live SQL Server/MySQL/MariaDB/Oracle/PostgreSQL processes on Linux via ODBC/JDBC, showing query execution time, CPU/

### Step 5: Compile Linux Performance Tuning Report [openai]
## Key Findings
...
- **Zabbix**: Provides infrastructure-level monitoring, suitable for comprehensive database server manag

## Phase 4: Deliverable
- /api/intake/task/t_mms6nweuwys5/export?fmt=md
